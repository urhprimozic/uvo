...
def hitri(tek):
    ...
    for i in tek:
        ...
        if i == 'Z':
            x -= v
            v = 1
        # tole zdj bo mal čudn napisan ja
        for j in range(1, 10):
            if str(j) == i:
                v = j
    return (x, y)
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzYzLCJwYXJ0Ijo5ODYyfQ:1jCqjg:NIa6qzDepXiMPcfigMohUicBiwQ'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzYzLCJwYXJ0Ijo5ODYzfQ:1jCqjg:iojtQOONzxqOuQMB8kAkTH9NZ2I'
        try:
            try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzYzLCJwYXJ0Ijo5ODY0fQ:1jCqjg:L8zNYJ-12jThWy_JASXNLx-HTBI'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzYzLCJwYXJ0Ijo5ODY1fQ:1jCqjg:eax0jpMa7IJq-ZbDoBGkfA431rM'
        try:
