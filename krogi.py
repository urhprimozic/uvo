...
def v_preseku(x, y, krogi):
    if len(krogi) == 0:
        return True
    if len(krogi) == 1:
        return v_uniji(x, y, krogi)
    return v_uniji(x, y,krogi[0:1]) and v_preseku(x, y, krogi[1:])
# =====================================================================@001313=
# 3. podnaloga
...
def pravokotnik(krogi):
    ...
    return (min(x - r, pravokotnik(krogi[1:])[0]), min(y - r, pravokotnik(krogi[1:])[1]), max(x + r,pravokotnik(krogi[1:])[2]), max(y + r, pravokotnik(krogi[1:])[3]))
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzYzLCJwYXJ0IjoxMzExfQ:1jBlMM:0EaIzhrsv-dBP8m5ZGDM_LMf8GE'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzYzLCJwYXJ0IjoxMzEyfQ:1jBlMM:W0LX5MK2jeycxjE5spKtVm9Rxyw'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzYzLCJwYXJ0IjoxMzEzfQ:1jBlMM:xIdFSai1NJHL-cJZOMN3lpmVD_s'
        try:
