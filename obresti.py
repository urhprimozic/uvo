...
def enostavno_obrestovanje(polog, mesecna_obrestna_mera, st_mesecev):
    return polog * (1 + st_mesecev * mesecna_obrestna_mera)
# =====================================================================@000923=
# 2. podnaloga
...
def pretvori_v_letno_obrestno_mero(mesecna_obrestna_mera):
    return round(100*((1 + mesecna_obrestna_mera) ** 12 - 1))
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzYzLCJwYXJ0Ijo5MjJ9:1j4ijU:ffYocmXBUEXGZCd3g9QAXxUKBjo'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzYzLCJwYXJ0Ijo5MjN9:1j4ijU:xNW_5QGyQxq2FSZdLZQRFVB5lRo'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzYzLCJwYXJ0Ijo5MzV9:1j4ijU:bP8oVC4H1xvRRn6fjOC6mPSocAI'
        try:
