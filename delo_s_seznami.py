...
def porezani_podseznami(sez):
    # kao ne znamo zank in hočemo maščevanje velikih bogovov Stacka
    # maščevanje bo KRVAVO
    # mali otroci bodo lačni in ne bo več risank 
    if len(sez) == 0:
        return [sez]
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzYzLCJwYXJ0Ijo5NzY5fQ:1jBlLm:TipIDl-3V62B7zDS8Vr5c2ffu9w'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzYzLCJwYXJ0Ijo5NzcwfQ:1jBlLm:4E0lysLj-psjji2d4V3EtLegUM0'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzYzLCJwYXJ0Ijo5NzcxfQ:1jBlLm:XVNwFcZwYiO3FR-2cERJ9lvCzrU'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzYzLCJwYXJ0Ijo5ODEyfQ:1jBlLm:6LKv7pq8-FkrVzv2QjxIuOHmfuI'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzYzLCJwYXJ0IjoyMDExNn0:1jBlLm:7SKYP7hA7hTIyGy4yssVDuixFMU'
        try:
