...
def binomski_ucinkovit(n, k):
    if k == 0:
        return 1
    return int(binomski_ucinkovit(n, k - 1) * ((n - k + 1) / k))
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzYzLCJwYXJ0Ijo5NTB9:1j6JUL:tv6p-c_WZTvLCRSk7NVCHvQsNRQ'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzYzLCJwYXJ0Ijo5NTF9:1j6JUL:HH4r9j7ZkGUks1dmWBeXBAhtdcM'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzYzLCJwYXJ0Ijo5NTJ9:1j6JUL:NJaoDsVZo6vh7pytNOwY90ertIc'
        try:
