...
# vanjo vpiše
# te rešitve in datoteko poženete (v urejevalniku Visual Studio Code
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzYzLCJwYXJ0Ijo5MDd9:1j46MY:kXyTInVhLBPeivpk7ZtNpw_Ba2o'
        try:
            try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzYzLCJwYXJ0Ijo5MDh9:1j46MY:sufHWwtBovAc66TLzsDlhEReVEs'
        try:
            try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzYzLCJwYXJ0Ijo5MDl9:1j46MY:MSm25i4vhG6c-kXXausZsbASSYQ'
        try:
            try:
