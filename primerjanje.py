...
#     False
# =============================================================================
def vecji_element(sez, n):
    # že spet kličemo demone z rekurzijo
    # kaj mi bo duša če pa lahk dissam zanke
    if len(sez) == 0:
        return 0
    if sez[0] > n:
        return True
...
def vsi_vecji(sez1, sez2):
    if len(sez1) == 0:
        return True
    return prvi_najvecji([sez1[0]] + sez2) and vsi_vecji(sez1[1:], sez2)
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzYzLCJwYXJ0IjoxMzEyOH0:1jBlLt:hqwEyesdxFUfcPUVon446xCQ4K0'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzYzLCJwYXJ0IjoxMzEyOX0:1jBlLt:UEShl3m_V0QnycrbSjNj0HJ_Pck'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzYzLCJwYXJ0IjoxMzEzMn0:1jBlLt:RUDwNS6L5zkalnmkHOgdDJYic5M'
        try:
