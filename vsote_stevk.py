...
def vsota_vecjih_stevk(n, k = 0):
    ...
    if n < 10: 
        return stevka
    return stevka + vsota_vecjih_stevk(n // 10, k)
# =====================================================================@000958=
# 3. podnaloga
...
def najmanjse_stevilo_z_vsoto_stevk(n):
    ...
    for i in range(9, 0, -1):
        if n - i >= 0:
            return 10 * najmanjse_stevilo_z_vsoto_stevk(n - i) + i
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzYzLCJwYXJ0Ijo5NTZ9:1j6Ifh:PMykX07b6xxcdW0hRtJhYtppwtQ'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzYzLCJwYXJ0Ijo5NTd9:1j6Ifh:9m-zYIbO1sZAOARHdF-nfZNKu90'
        try:
            try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzYzLCJwYXJ0Ijo5NTh9:1j6Ifh:JKENoEIHbyX8vbayGEMrERMqFok'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzYzLCJwYXJ0Ijo5NTl9:1j6Ifh:QL9dRbMn4v_oQMWczB0M_L6TCw8'
        try:
            for i in range(1, 100):
