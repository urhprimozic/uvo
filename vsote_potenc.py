...
def vsota_prvih_potenc(n, k = 1):
    # tud to ma drugač užitno rešitev brez rekurzije....
    if n == 1:
        return 1
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzYzLCJwYXJ0Ijo5NTN9:1j6Hu5:3Uz5T3ISlto3ZczMKH6QV8q3bKg'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzYzLCJwYXJ0Ijo5NTR9:1j6Hu5:qhAu55NuOTM5RJJubh5L298lzHI'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo1MzYzLCJwYXJ0Ijo5NTV9:1j6Hu5:g4ySdreJ6Eq1KTWiYsv1eA2ar38'
        try:
            try:
